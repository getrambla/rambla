...
export async function startNpmRegistry(packages: FixturePackage[]) {
  const root = await mkdtemp(path.join(tmpdir(), "rambla-npm-registry-"));
...
export function npmPluginPackages() {
  const files = {
    ...
    "index.server.ts": `import value from "rambla-fixture-dependency";
export default function contribute() {
  ...
  return [
    {
      name: "rambla-fixture-dependency",
      version: "1.0.0",
      files: { "index.js": 'module.exports = "dependency loaded";' },
    },
    {
      name: "rambla-fixture-plugin",
      version: "1.0.0",
      files,
    ...
    {
      name: "@rambla-fixture/review",
      version: "2.0.0",
      files,
      dependencies: { "rambla-fixture-dependency": "1.0.0" },
      peerDependencies: { "@getrambla/plugin": "*" },
    },
  ];
}
