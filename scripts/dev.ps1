...
# Derive RAMBLA_HOME: stable name for worktrees, temporary dir otherwise
...
$env:EXPO_PUBLIC_RAMBLA_DEV_BUILD_LABEL = (git branch --show-current).Trim()
$env:RAMBLA_LISTEN = "127.0.0.1:6768"
$env:BROWSER = "none"
