...
Use this guide to update plugins written for Rambla 0.7 or earlier to the current client/server entry format, introduced in 0.8.
...
Keep your existing ID and build commands. Missing `requirements.rambla` means `<0.8.0`, so Rambla 0.8 and later
