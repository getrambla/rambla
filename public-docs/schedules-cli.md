...
Updating a heartbeat changes only its cron cadence and optional time zone. Its target and prompt stay fixed. Heartbeat commands require `RAMBLA_AGENT_ID`, which Paseo sets inside agent sessions.
