...
After approving login, answer **Yes** to **Connect this daemon to Rambla Hub?** and **Allow Hub automations to run agents on this daemon?**. Execution permission defaults to no, so enable it explicitly for this setup.
