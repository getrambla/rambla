...
description: Open directories as Rambla workspaces, place agents in them, follow changes, and archive them.
nav: Workspaces
order: 53
...
Use a workspace when an integration needs a durable place in the Rambla app for agents, terminals, browsers, and files related to one task.
...
Create a Rambla-owned worktree when concurrent work needs an isolated checkout:
