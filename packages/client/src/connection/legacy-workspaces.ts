import { AgentSnapshotPayloadSchema } from "@getrambla/protocol/messages";
import type { AgentSnapshotPayload, SessionOutboundMessage } from "@getrambla/protocol/messages";
import {
  deriveAgentStateBucket,
  getWorkspaceStateBucketPriority,
} from "@getrambla/protocol/agent-state-bucket";
...
function workspaceKind(checkout: AgentEntry["project"]["checkout"]): Workspace["workspaceKind"] {
  ...
  if (checkout.isRamblaOwnedWorktree) return "worktree";
  return "checkout";
}
...
function gitRuntime(checkout: AgentEntry["project"]["checkout"]): Workspace["gitRuntime"] {
  ...
  return {
    ...
    isRamblaOwnedWorktree: checkout.isRamblaOwnedWorktree,
    isDirty: null,
    aheadBehind: null,
    aheadOfOrigin: null,
    behindOfOrigin: null,
