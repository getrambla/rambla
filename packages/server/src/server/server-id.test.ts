...
describe("getOrCreateServerId", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.RAMBLA_SERVER_ID;
    home = tmpHome();
  });
  ...
  it("creates and persists a stable id per RAMBLA_HOME", () => {
  ...
  it("respects and persists RAMBLA_SERVER_ID override", () => {
    process.env.RAMBLA_SERVER_ID = "test-daemon-id";
