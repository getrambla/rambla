...
import type { CreationSnapshot } from "@getrambla/protocol/messages";
...
export class VoiceAssistantWebSocketServer {
  ...
  constructor(
    ...
    this.messageReceipts = new MessageReceipts(join(ramblaHome, "agent-requests"));
    this.creationService = new CreationService(
      join(ramblaHome, "creations"),
      this.logger.child({ module: "creation" }),
      (snapshot) => this.validateCompletedCreation(snapshot),
      join(ramblaHome, "agent-requests"),
    );
