...
import { defineSettings, settingsRpc, type SettingsDefinition } from "@getrambla/plugin";
import type { PluginSettings, PluginSettingsState } from "@getrambla/plugin/server";
