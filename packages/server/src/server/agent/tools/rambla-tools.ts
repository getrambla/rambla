...
export function createPaseoToolCatalog(options: PaseoToolHostDependencies): PaseoToolCatalog {
    ...
    z
      .object({
        ...
        worktreeSlug: z
          ...
          .min(1)
          .optional()
          .describe("Optional worktree slug/path label. Omit to let Rambla generate one."),
        branchName: z
          .string()
          .min(1)
          .optional()
      ...
      .strict()
      .describe("Create a new branch in a new Rambla worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out an existing branch in a new Rambla worktree."),
    z
      .object({
      ...
      .strict()
      .describe("Check out a GitHub pull request in a new Rambla worktree."),
  ]);
  ...
  registerTool(
    "create_workspace",
    {
      ...
      description:
        "Create a workspace using an existing local checkout or a new Rambla-managed worktree.",
      inputSchema: {
        isolation: z.enum(["local", "worktree"]),
        path: z
          .string()
