import type { AgentSnapshotPayload, ProjectPlacementPayload } from "@getrambla/protocol/messages";
import { scoreTextFields } from "@getrambla/protocol/search/text-match";
