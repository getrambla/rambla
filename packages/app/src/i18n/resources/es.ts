...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoRambla",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queRamblainicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroRamblano pudo detener el demonio.",
      ...
      keepRunning: {
        ...
        hint: "Daemonsigue ejecutándose cuando sales deRambla",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Ejecuta`rambla daemon status`y muestra la salida.",
        view: "Ver estado",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeRamblaenRosettaenApple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Prueba de notificaciónRambla",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elRamblaCLI.",
      },
    },
  },
  rootError: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorRambla.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      hint: "Escanee este códigoQRconRamblaen su teléfono o copie el enlace a continuación.",
      securityWarning:
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaRamblaen esta computadora.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deRambla?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesRambla?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónRamblade ~/.agents, ~/.claude, ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasRambla",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasRambla",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Ramblase vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Ramblase vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "rambla.json no se pudo analizar",
        ...
        transportTitle: "No se pudo cargar rambla.json",
        transportFallback: "El anfitrión no respondió.",
        failedTitle: "No se pudo cargar rambla.json",
      ...
      worktree: {
        ...
        uncommittedTitle: "Confirma los cambios de rambla.json",
      ...
      scripts: {
        ...
        serviceHint: "Ramblasupervisa el proceso y asigna un puerto vía $RAMBLA_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        title: "Generación de metadatos",
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queRamblautiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Vuelva a cargar para obtener el último rambla.json antes de guardar.",
        failedTitle: "No se pudo guardar rambla.json",
