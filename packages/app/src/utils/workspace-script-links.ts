import { parseHostPort } from "@getrambla/protocol/daemon-endpoints";
...
export type WorkspaceScriptLinkKind = "public" | "rambla" | "direct";
...
export function resolveWorkspaceScriptLink(input: {
  ...
  addTarget(targets, "rambla", localProxyUrl);
