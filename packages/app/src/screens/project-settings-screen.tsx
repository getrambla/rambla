...
function ProjectSettingsBody({
  ...
  const loadedConfig: RamblaConfigRaw | null = data?.ok ? (data.config ?? {}) : null;
  const loadedRevision: RamblaConfigRevision | null = data?.ok ? data.revision : null;
...
interface RenderContentInput {
  ...
  loadedConfig: RamblaConfigRaw | null;
  loadedRevision: RamblaConfigRevision | null;
...
function revisionToKey(revision: RamblaConfigRevision | null): string {
...
interface ProjectConfigFormProps {
  baseConfig: RamblaConfigRaw;
  revision: RamblaConfigRevision | null;
  hasUncommittedWorktreeSetupChanges: boolean;
  repoRoot: string;
  queryKey: readonly [string, string, string];
  client: DaemonClient;
