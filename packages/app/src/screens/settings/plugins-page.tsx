import { formatPluginInstallation } from "@getrambla/protocol/plugin-source-reference";
...
const PLUGIN_SOURCE_DOCS_URL = "https://rambla.sh/docs/plugins/reference#plugin-sources";
