...
export const APP_SETTINGS_KEY = "@rambla:app-settings";
export const LEGACY_SETTINGS_KEY = "@rambla:settings";
 ...
 * a schema change.
 */
export const SETTINGS_MIGRATIONS_KEY = "@rambla:settings-migrations";
