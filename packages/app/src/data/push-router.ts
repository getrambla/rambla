import type { OwnedSubscription } from "@getrambla/client";
...
interface ServerDataPushClient {
  ...
  observeEvents: import("@getrambla/client/internal/daemon-client").DaemonClient["observeEvents"];
  observeCheckoutDiff: import("@getrambla/client/internal/daemon-client").DaemonClient["observeCheckoutDiff"];
  observeTerminals: import("@getrambla/client/internal/daemon-client").DaemonClient["observeTerminals"];
}
