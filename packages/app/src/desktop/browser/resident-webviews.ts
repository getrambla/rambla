...
const RESIDENT_BROWSER_HOST_ID = "rambla-browser-resident-webviews";
const BROWSER_ID_ATTRIBUTE = "data-rambla-browser-id";
const BROWSER_SURFACE_ATTRIBUTE = "data-rambla-browser-surface";
