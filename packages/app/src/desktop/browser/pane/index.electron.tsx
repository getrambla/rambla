...
function buildAnnotationMarkerScript(markers: readonly BrowserAnnotationMarker[]): string {
  ...
  return `
    (function() {
      var markers = ${payload};
      if (window.__ramblaAnnotationMarkers) { window.__ramblaAnnotationMarkers.update(markers); return true; }
      ...
      window.__ramblaAnnotationMarkers = {
        ...
        destroy: function() {
          ...
          window.__ramblaAnnotationMarkers = null;
        }
      };
      reposition();
      return true;
...
function clearAnnotationMarkers(webview: ElectronWebview): void {
  void executeWebviewJavaScript(
    webview,
    "if(window.__ramblaAnnotationMarkers) window.__ramblaAnnotationMarkers.destroy();",
