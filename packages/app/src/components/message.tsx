...
import type { AgentCapabilityFlags } from "@getrambla/protocol/agent-types";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "rambla-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "rambla-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--rambla-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--rambla-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return inlineUnistylesStyle({
    ...
    "--rambla-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--rambla-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  });
}
