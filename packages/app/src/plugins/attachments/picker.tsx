...
import type { PluginAttachmentItem, PluginAttachmentSourceContribution } from "@getrambla/plugin";
import { searchPluginAttachments } from "@getrambla/plugin/client/host";
