...
const GROUPED_PROJECT_NAME = "rambla-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/rambla-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.ramblaHome, "projects", "projects.json");
