...
import { useAgent, useWorkspace, openExternalUrl } from "@getrambla/plugin/client";
...
function contributeClient(client) {
  ...
  void client.rambla.agents.list({ subscribe: {}, signal: lifetime.signal }).then(({ subscription }) => {
