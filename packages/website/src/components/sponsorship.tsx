...
export function FounderNote() {
  return (
    <div className="max-w-2xl space-y-5 leading-relaxed text-white/70">
      <p>
        I build Rambla on my own. There are no investors, no board and no company behind it, and I
      ...
      <p>
        Rambla is self-funded: the work is paid for by sponsorship and by{" "}
        <a href="/hub" className="underline hover:text-white/90">
          Rambla Hub
        </a>
        , an optional hosted service. Your support is what lets me work on Rambla full time.
      </p>
...
const SPOT_FEATURES: ReadonlyArray<string> = [
  "Your logo on the homepage of rambla.sh, around 70,000 visitors a month",
  ...
  return (
    <section id="spot" className="scroll-mt-8">
      <SectionHeading
        ...
        description="If your team relies on Rambla, a monthly sponsorship funds its development directly. As a thank you, your logo goes on the homepage and in the README."
      />
...
export function SponsorRamblaSection() {
  return (
    <section>
      <SectionHeading as="h1" title="Sponsor Rambla" />
...
export function SponsorSection() {
  return (
    <section>
      <SectionHeading as="h2" title="Sponsor Rambla" />
      <div className="space-y-10">
        <div className="max-w-2xl space-y-5 leading-relaxed text-white/70">
          <p>
            I build Rambla on my own, with no investors and no company behind it, and I have turned
          ...
          <p>
            Rambla is self-funded through sponsorship and{" "}
            <a href="/hub" className="underline hover:text-white/90">
              Rambla Hub
            </a>
...
/** Homepage: the companies sponsoring Rambla. Renders nothing until there is one. */
