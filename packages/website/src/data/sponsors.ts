...
export const SPONSOR_CONTACT_EMAIL = "hello@rambla.sh";

export const GITHUB_SPONSORS_URL = "https://github.com/sponsors/boudra";
export const OPEN_COLLECTIVE_URL =
  "https://opencollective.com/rambla-ai/donate?interval=month&amount=10&contributeAs=me";
export const BUY_ME_A_COFFEE_URL = "https://buymeacoffee.com/rambla";
