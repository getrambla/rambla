...
export const Route = createFileRoute("/docs/")({
  head: () => {
    ...
    if (!doc)
      return pageMeta(
        "Docs - Rambla",
        "Install Rambla and start running coding agents from your phone, desktop, and terminal.",
        "/docs",
      );
    return pageMeta(`${doc.frontmatter.title} - Rambla Docs`, doc.frontmatter.description, "/docs");
  },
  component: DocsIndex,
});
