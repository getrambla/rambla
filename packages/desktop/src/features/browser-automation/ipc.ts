...
import { BrowserAutomationExecuteRequestSchema } from "@getrambla/protocol/browser-automation/rpc-schemas";
import type {
...
export function registerBrowserAutomationIpc(options?: { ipc?: IpcHandlerRegistry }): void {
  ...
  ipc.handle("rambla:browser:execute-automation-command", async (event, rawRequest: unknown) => {
