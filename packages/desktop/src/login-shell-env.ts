...
const TIMEOUT_ENV_KEY = "RAMBLA_SHELL_ENV_TIMEOUT_MS";
...
function resolveShellEnv({ deps, timeoutMs }: ResolveShellEnvInput): ResolvedShellEnv {
  ...
  delete shellEnv.RAMBLA_NODE_ENV;
  delete shellEnv.RAMBLA_DESKTOP_MANAGED;
  delete shellEnv.RAMBLA_SUPERVISED;
