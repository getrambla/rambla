...
import { readDaemonInstance } from "@getrambla/server";
  ...
  try {
    ...
    desktop = await electron.launch({
      ...
      env: {
        ...
        RAMBLA_DISABLE_SINGLE_INSTANCE_LOCK: "1",
        RAMBLA_ELECTRON_USER_DATA_DIR: path.join(root, "renderer-user-data"),
      },
    });
