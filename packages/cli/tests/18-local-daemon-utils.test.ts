...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/rambla.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/rambla.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\rambla-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\rambla-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.rambla\\rambla.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\rambla.sock"), null);
