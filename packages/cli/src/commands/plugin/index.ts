...
export async function runPluginInstallCommand(
  ...
  process.stderr.write(
    "Trusting plugin code: server code and preparation commands run unsandboxed on the daemon host; client code runs inside Rambla. Dependencies and future updates are part of the codebase you trust.\n",
  );
