# Contributing to Rambla

This guide is here to save us both time and help you find a useful way to contribute.

Rambla grows through bug reports, testing, workflow discussions, plugins, documentation, and people helping each other. The sections below explain where each contribution belongs and what to expect.

## Philosophy

**Rambla has a lean, opinionated core built to be extended.**

The goal is a low floor and a high ceiling: a polished default experience that is easy to understand, with the flexibility to choose your providers, run on your own infrastructure, and build your own workflows. Rambla should remain self-hosted and respectful of your privacy and control.
...
Read the [product philosophy](docs/product.md) for the reasoning behind these choices and how Rambla develops.

## Build a plugin

Most specialized workflows and integrations are better served by plugins.

Plugins let you build what you need, share it, and maintain it independently. Start with the [plugin documentation](https://rambla.sh/docs/plugins). For applications and integrations built around Rambla, see the [SDK documentation](https://rambla.sh/docs/sdk).
...
- Reproduction steps, Rambla version, and platform.
...
- Where does Rambla get in the way?
...
Rambla receives more pull requests than I can responsibly review. Reviewing every submission and explaining every decision would consume the time available for developing the product.
...
- **A finished experience.** Follow the [design guidelines](docs/design.md). The feature must look and feel right in Rambla, including loading states, layout stability, and interaction performance. PRs with janky or rushed interfaces will be closed. Design judgment remains with the maintainer.
...
Testing betas, reproducing bugs, improving documentation, sharing plugins, and answering questions all help Rambla develop.
