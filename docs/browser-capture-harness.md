...
The existing `npm run test:e2e:browser-tabs --workspace=@getrambla/desktop` journey
...
[the full-page repetition bug](https://github.com/getrambla/rambla/issues/3196).
