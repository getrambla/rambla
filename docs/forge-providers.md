# Adding a Git Forge to Rambla

Rambla's forge layer is a registry/manifest system. A forge is a runtime concern:
...
allowlist. Self-hosted detection is a trust gate: Rambla only talks to a forge
